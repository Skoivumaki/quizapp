...
export default async function PlayerPage() {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-row sticky w-full top-0 bg-gray-950 text-center justify-between items-center h-10">
        ...
        <div className="bg-gradient-to-t from-gray-950 via-gray-700 to-gray-950 flex flex-col p-4 h-68 justify-center">
